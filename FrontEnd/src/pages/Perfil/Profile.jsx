        ...
        <div className="conteiner">
            ...
            {/*   <div className="h-screen m-10 flex flex-col md:flex-row">
                ...
                <div className="bg-gray-300 h-screen w-3/5 rounded-3xl p-2 overflow-y-auto">
                    <h1 className="text-gray-500 m-2">Nombre completo</h1>
                    <h1 className="ml-8 mb-8">No Especificado</h1>
                    <h1 className="text-gray-500 m-2">Nombre Publico</h1>
                    <h1 className="ml-8 mb-8">No Especificado</h1>
                    <h1 className="text-gray-500 m-2">Correo electronico</h1>
                    <h1 className="ml-8 mb-8">No Especificado</h1>
                </div>
            ...
            <div>
                ...
                <div className="w-auto mx-60 mt-5">
                    ...
                    <div>
                        ...
                        <h1 className="m-5 text-2xl text-gray-500">Redes</h1>

                        <div className="ml-8">
                        <a href="#">
                            <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 inline m-3" fill="currentColor" viewBox="0 0 24 24">
