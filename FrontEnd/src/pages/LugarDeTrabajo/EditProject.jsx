...
const handleClick=()=>{
  if(confirm('Quieres eliminar el proyecto actual?')){
...
return (loading?'loading...':(
    ...
    <h1 className="font-bold text-4xl">Editar proyecto:{name}</h1>
    <div className="flex items-center gap-1 text-gray-100 hover:text-cyan-700">
