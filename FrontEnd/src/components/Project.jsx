...
const{getProject,project,loading,handleTaskModal,
  alert,submitTasksProject,deleteTaskProject,updateTaskProject,changeStateTask}=useProjects()
...
const { msg } = alert
  ...
  return (<><div className="flex justify-between">
    <h1 className="font-bold uppercase text-xl opacity-50">{user}</h1>

    {admin && (<div className="font-bold flex items-center gap-1 text-gray-100 hover:text-cyan-700">
    ...
    type="button"
    className="text-sm mt-5 px-5 py-3w w-full md:w-auto rounded-xl uppercase flex gap-2
    font-bold bg-teal-700 hover:bg-gray-300 hover:text-gray-800 text-gray-200 text-center items-center justify-center">
      Nueva tarea
      <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={2.5} stroke="currentColor" className="w-6 h-6 m-2">
  ...
  <>
    <div className='flex items-center justify-between mt-10'>
        ...
        <Link
          ...
          className='text-gray-100 hover:text-black uppercase font-bold'
        >Añadir nuevo miembro</Link>
    </div>
